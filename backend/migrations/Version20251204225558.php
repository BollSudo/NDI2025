 ...
 */
final class Version20251204225558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE access_token ADD user_id INT NOT NULL, ADD value VARCHAR(255) NOT NULL, ADD expires_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B6A2DD681D775834 ON access_token');
        $this->addSql('DROP INDEX IDX_B6A2DD68A76ED395 ON access_token');
        $this->addSql('ALTER TABLE access_token DROP user_id, DROP value, DROP expires_at');
    }
}
